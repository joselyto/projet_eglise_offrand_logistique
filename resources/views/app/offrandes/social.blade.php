...
@section('content')
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <div class="dropdown">
                    <a href="{{ route('offrande.socialForm') }}" class="btn btn-primary">
                        Ajouter nouveau
                    </a>
    ...
    <div class="card-box mb-30">
        ...
        <div class="pd-20 d-flex justify-content-between">
            <div class="dropdown">
                <a href="{{ route('offrande.social.dollar') }}" class="btn btn-primary">
                    En dollar($)
                </a>
                
            </div>
            <div class="dropdown">
                <a href="{{ route('offrande.social.franc') }}" class="btn btn-primary">
                    En franc(FC)
                </a>
                
            </div>
            <h4 class="text-blue h4">Vue d'ensemble de l'offrande Social</h4>
