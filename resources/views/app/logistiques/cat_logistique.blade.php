    ...
    <div class="card-box mb-30">
        ...
        <div class="pb-20">
            <table class="table hover multiple-select-row data-table-export nowrap">
                ...
                <tbody>
                    @foreach ($categorie_logis as $categorie_logi)
                        <tr>
                            <td>{{ $categorie_logi->id }}</td>
                            <td>{{ $categorie_logi->libelle }}</td>
                            <td>{{ $categorie_logi->quantite }}</td>
                            <td>{{ $categorie_logi->created_at }}</td>
                            <td><a href="{{ route('mouv.logistique.form', $categorie_logi->id) }}" class="btn btn-primary">Mouvement</a>
                            </tr>
                    @endforeach
