				...
				<ul id="accordion-menu">
					<li class="dropdown">
						...
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-money-1"></span><span class="mtext">Les utilisateurs</span>
						</a>
						<ul class="submenu">
							<li><a href="{{ route('utilisateurs') }}">Les utilisateurs</a></li>
							<li><a href="{{ route('demande') }}">Demande d'acces</a></li>
						</ul>
					</li>
					<li >
						<li class="dropdown">
							...
							<a href="javascript:;" class="dropdown-toggle">
								<span class="micon dw dw-money-1"></span><span class="mtext">Les videos</span>
							</a>
							<ul class="submenu">
								<li><a href="{{ route('videos_form') }}">Les videos</a></li>
							</ul>
						</li>
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-user-11 "></span><span class="mtext">Contact</span>
						</a>
						<ul class="submenu">
							<li><a href="{{ route('offrande.social') }}">Les messages</a></li>
