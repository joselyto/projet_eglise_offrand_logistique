				...
				<ul id="accordion-menu">
					<li class="dropdown">
						...
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-money-1"></span><span class="mtext">Les materiels</span>
						</a>
						<ul class="submenu">
							<li><a href="{{ route('logistique') }}">Vue d'ensemble</a></li>
							<li><a href="{{ route('logistique.form') }}">Nouveau</a></li>
						</ul>
					</li>
					<li>
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-user-11 "></span><span class="mtext">La categorie</span>
						</a>
						<ul class="submenu">
							<li><a href="{{ route('categorie') }}">Vue d'ensemble</a></li>
							<li><a href="{{ route('categorie.form') }}">Nouveau</a></li>
						</ul>
						
					</li>
					<li>
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-user-11 "></span><span class="mtext">Mouvement</span>
						</a>
						<ul class="submenu">
							<li><a href="{{ route('mouvement') }}">Mouvement</a></li>
