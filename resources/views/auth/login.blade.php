	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			...
			<div class="login-menu">
				<ul>
					<li><a href="{{ route('register') }}">Demande d'acces</a></li>
				</ul>
			</div>
		</div>
	</div>
					...
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						<form method="POST" action="{{ route('login') }}">
							...
							<div class="input-group custom">
								<input type="text" class="form-control form-control-lg" placeholder="Votre email" name="email">
							...
							<div class="row">
								<div class="col-sm-12">
									...
									<div class="input-group mb-0">
										<a class="btn btn-outline-primary btn-lg btn-block" href="{{ route('register') }}">Demande d'acces</a>
									</div>
								</div>
							</div>
